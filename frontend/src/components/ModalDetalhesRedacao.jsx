...
import { X, Award, UserCheck, UserX, Image as ImageIcon, Save, Sparkles, BookOpen, Quote, ShieldCheck, Compass, Copy, Check, Printer, FileText, Download, Loader2, Edit3 } from 'lucide-react';
          ...
          <div className="p-5 border-b border-[#e6e5e0] bg-[#fafaf7] flex items-start justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 flex-wrap mb-1">
                ...
                {(redacao.turma_aluno || data.turma) && (
